...
```
                      ...
                      +--------+--------+
                               |
                      +--------v--------+
                      | Analyze Query   |  <-- LLM judges query type
                      +--------+--------+
                               |
            +------------------+------------------+
            |                  |                  |
...
> Analyze Query = 分析问题 | Direct Answer = 直接回答 | Retrieve = 检索 | Decompose = 分解问题 | Evaluate Result = 评估检索质量 | Generate = 生成回答
